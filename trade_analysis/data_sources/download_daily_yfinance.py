...
import sys
log_file = logging.FileHandler(str(LOGS_DIR / 'download_log.txt'), encoding='utf-8')
...
def download_ticker(ticker: str, output_dir: str = str(DATA_DIR / "historical_data"), 
...
def main(tickers_source: str = 'manual', 
         max_workers: int = 5, 
         output_dir: str = str(DATA_DIR / "historical_data"),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default=str(DATA_DIR / "historical_data"),
                       help="Output directory (default: trade_analysis/data/historical_data)")
