...
class SignalValidator:
    def __init__(self, log_file="strategy_trader_log.txt"): # <-- Note: Default log file changed
    ...
    def generate_report(self, output_file="signal_validation_report.html"):
...
def main():
    # Make sure your new log file is named 'strategy_trader_log.txt'
    validator = SignalValidator(log_file="strategy_trader_log.txt") 
    validator.generate_report(output_file="signal_validation_report.html")
